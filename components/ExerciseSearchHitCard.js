...
const ExerciseSearchHitCard = ({ hit, handleAddExercise, setDropdownOpen }) => {
  ...
  return (
    ...
    >
      <div className="aspect-square h-[50px] w-[50px] relative my-auto mr-4 cursor-pointer  rounded-lg bg-gray-100">
        {hit.poster && (
          <Image
            src={hit.poster}
            fill={true}
        ...
        {!hit.poster && (
          <div className="w-full h-full flex">
            <FaDumbbell className="m-auto text-gray-200 text-xl" />
          </div>
        )}
      </div>
